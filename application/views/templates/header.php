...
<html lang="en">
    <head>
       ...
       <!-- Required meta tags -->
        ...
        <script type="text/javascript" src="/ci_new/public/js/grid/gridService.js"></script>
        <script type="text/javascript" src="/ci_new/public/js/grid/gridCtrl.js"></script>

        <title>CodeIgniter with AngularJS</title>
    </head>
